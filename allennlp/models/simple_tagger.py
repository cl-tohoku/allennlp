...
class SimplerTagger(Model):
    ...
    def __init__(self, vocab: Vocabulary,
                 ...
                 initializer: InitializerApplicator = InitializerApplicator(),
                 regularizer: Optional[RegularizerApplicator] = None) -> None:
        super(SimplerTagger, self).__init__(vocab, regularizer)

        self.text_field_embedder = text_field_embedder
        self.num_classes = self.vocab.get_vocab_size("labels")
        self.tag_projection_layer = TimeDistributed(Linear(text_field_embedder.get_output_dim(),
                                                           self.num_classes))
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'SimplerTagger':
        embedder_params = params.pop("text_field_embedder")
        text_field_embedder = TextFieldEmbedder.from_params(vocab, embedder_params)
